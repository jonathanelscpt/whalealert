...
from .session import WhaleAlertAPISession
...
class BaseAPI(object):
    ...
    def __init__(
        ...
        Args:
            ...
            api_key (str): RPC username for protected APIs.
        """
        self._url = 'https://api.whale-alert.io/'
        self.version = version
        self.session = WhaleAlertAPISession()
        if api_key:
            self.session.init_auth(api_key)

    @property
    def url(self):
        return urljoin(self._url, self.version)
